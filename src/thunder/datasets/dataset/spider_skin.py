...
def create_splits_spider_skin(base_folder: str, dataset_cfg: dict) -> None:
    ...
    (
        ...
        spider_skin_folder, "center_crop/train", dataset_cfg
    )
    ...
    (
        spider_skin_data_splits["val"]["images"],
        spider_skin_data_splits["val"]["labels"],
    ) = (
        train_val_images[val_mask].tolist(),
        train_val_labels[val_mask].tolist(),
    )
    (
        spider_skin_data_splits["train"]["images"],
        spider_skin_data_splits["train"]["labels"],
    ) = (
        train_val_images[~val_mask].tolist(),
        train_val_labels[~val_mask].tolist(),
    )
    ...
    (
        ...
        spider_skin_folder, "center_crop/test", dataset_cfg
    )

    check_dataset(
        spider_skin_data_splits,
        dataset_cfg,
        base_folder,
    )
    ...
    save_dict(
        spider_skin_data_splits,
        os.path.join(base_folder, "data_splits", "spider_skin.json"),
    )
